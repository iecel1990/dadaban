...
<body>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${categorys.content}" var="category">
			<tr>
				<td><a href="${ctx}/category/update/${category.id}">${category.name}</a></td>
				<td><a href="${ctx}/category/delete/${category.id}">删除</a></td>
			</tr>
		</c:forEach>
		</tbody>
	</table>
	...
	<div><a class="btn" href="${ctx}/category/create">创建任务</a></div>
</body>
</html>
