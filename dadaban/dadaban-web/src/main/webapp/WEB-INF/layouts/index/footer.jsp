            ...
            <div class="col-md-4 col-sm-4 space-mobile">
                ...
                <div class="blog-photo-stream margin-bottom-30">
                    <ul class="list-unstyled">
                        ...
                        <li><a href="#"><img src="${ctx}/static/assets/img/works/img2.jpg" alt=""></a></li>
                        <li><a href="#"><img src="${ctx}/static/assets/img/works/img5.jpg" alt=""></a></li>
                    </ul>
                </div>
...
<script type="text/javascript" src="${ctx}/static/assets/plugins/hover-dropdown.js"></script>
<script type="text/javascript" src="${ctx}/static/assets/plugins/back-to-top.js"></script>
<!-- END CORE PLUGINS -->

<!-- BEGIN PAGE LEVEL JAVASCRIPTS(REQUIRED ONLY FOR CURRENT PAGE) -->
<script type="text/javascript" src="${ctx}/static/assets/plugins/fancybox/source/jquery.fancybox.pack.js"></script>
<script type="text/javascript" src="${ctx}/static/assets/plugins/revolution_slider/rs-plugin/js/jquery.themepunch.plugins.min.js"></script>
<script type="text/javascript" src="${ctx}/static/assets/plugins/revolution_slider/rs-plugin/js/jquery.themepunch.revolution.min.js"></script>
<script type="text/javascript" src="${ctx}/static/assets/plugins/bxslider/jquery.bxslider.min.js"></script>
<script src="${ctx}/static/assets/scripts/app.js"></script>
<script src="${ctx}/static/assets/scripts/index.js"></script>
<script src="${ctx}/static/assets/plugins/jquery.mixitup.min.js"></script>
<script src="${ctx}/static/assets/scripts/portfolio.js"></script>
